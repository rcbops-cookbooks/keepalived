...
action :create do
  params = Hash.new()
  attributes = ['notify_master', 'notify_backup', 'notify_fault', 'interface', 'virtual_router_id', 'state', 'nopreempt', 'preempt_delay', 'priority', 'virtual_ipaddress', 'advert_int', 'auth_type', 'auth_pass', 'track_script']
